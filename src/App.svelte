<script>
  ...
  const links = [
    { id: 1, title: 'my tg channel', icon: 'telegram', url: 'https://t.me/whyheavensdsgn', tooltip: 'Открыть Telegram', tooltipPos: 'top' },
    { id: 2, title: 'spotify profile', icon: 'spotify', url: 'https://open.spotify.com/user/31cfl4nwnnflv5lmsxnial3zmz34?si=c0192711422c44b7', tooltip: 'Открыть Spotify', tooltipPos: 'bottom' }
  ];
  ...
  const contextMenuItems = [
    { icon: 'copy', label: 'Копировать ссылку', action: () => navigator.clipboard.writeText('https://whyheavens.site') },
    { icon: 'share', label: 'Поделиться', action: () => navigator.share?.({ url: 'https://whyheavens.site', title: 'whyheavens' }) },
    { type: 'separator' },
    { icon: 'telegram', label: 'Telegram', action: () => window.open('https://t.me/whyheavensdsgn', '_blank') },
    { icon: 'spotify', label: 'Spotify', action: () => window.open('https://open.spotify.com/user/31cfl4nwnnflv5lmsxnial3zmz34?si=c0192711422c44b7', '_blank') },
    { type: 'separator' },
  ...
  const spotlightItems = [
    { icon: 'person', title: 'О дизайнере', desc: 'whyheavens — дизайнер, люблю котиков', action: () => {} },
    { icon: 'telegram', title: 'Telegram', desc: 'Открыть канал в Telegram', action: () => window.open('https://t.me/whyheavensdsgn', '_blank') },
    { icon: 'spotify', title: 'Spotify', desc: 'Открыть профиль Spotify', action: () => window.open('https://open.spotify.com/user/31cfl4nwnnflv5lmsxnial3zmz34?si=c0192711422c44b7', '_blank') },
    ...
    { icon: 'github', title: 'Made by', desc: 'denys-shatin', action: () => window.open('https://github.com/denys-shatin', '_blank') },
  ];
  ...
  function handleZoom() {
    window.open('https://t.me/whyheavensdsgn', '_blank');
  }
